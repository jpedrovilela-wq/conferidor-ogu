/* Base territorial do IBGE — DTB 2024 (posição em 31/12/2024).
 * Cada registro usa o código municipal de seis dígitos empregado no CSV FGTS.
 */
var IBGE_MUNICIPIOS_TEXTO = `
...
510780|Santo Antônio de Leverger|MT
...
var IBGE_MUNICIPIOS = Object.create(null);
IBGE_MUNICIPIOS_TEXTO.trim().split('\n').forEach(function (linha) {
  var partes = linha.split('|');
  if (partes.length === 3) IBGE_MUNICIPIOS[partes[0]] = [partes[1], partes[2]];
});
